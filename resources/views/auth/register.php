...
<div class="flex justify-center items-center h-screen">
    <div class="shadow-out rounded-xl p-8 w-80"> 
        ...
        <div id="error-msg" class="text-center text-red-500 mb-2 text-sm"></div>
        <form id="register-form">
            <div class="relative z-0 w-full mb-6 group">
                ...
                <div id="username-error" class="text-red-500 text-xs"></div>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                ...
                <div id="password-error" class="text-red-500 text-xs"></div>
            </div>
